    ...
    <div className="home-container">
      <section className="hero-section">
        ...
        <p className="hero-subtitle">
          The next-generation streaming platform with low-latency playback and
          ultra-fast delivery.
        </p>
        <div>
          {isAuthenticated ? (
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p className="feature-description">
              Experience real-time streaming with sub-second latency using
              cutting-edge WebRTC and LL-HLS technologies.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p className="feature-description">
              Protect your content with advanced security features including
              signed URLs and token-based authentication.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p className="feature-description">
              Stream and watch on any device with our responsive player that
              adapts to various screen sizes and network conditions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section">
        ...
        <p className="cta-description">
          Join thousands of creators who use OvenPlatform to connect with their
          audience through high-quality, low-latency streams.
        </p>
        {isAuthenticated ? (
          <Link to="/streams" className="hero-cta">
            Go to Streams
